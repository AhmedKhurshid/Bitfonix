...
<div id="admin-content">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2">
                <a class="add-new" href="addcategory.php">add category</a>
            </div>
            <div class="col-md-12">
              <?php
              ...
              if (mysqli_num_rows($result) > 0) {
                  ...
                  while($row = mysqli_fetch_assoc($result)) {
                    $table .= "<tr>
                            ...
                            <td>{$row["c_id"]}</td>
                            <td>{$row["c_Name"]}</td>
                            <td class='edit'><a href='updatecategory.php?id={$row['c_id']}' ><i class='fa fa-edit'></i></a></td>
                            <td class='delete'><a href='deletecategory.php?id={$row['c_id']}'><i class='fa fa-trash-o'></i></a></td>
                        </tr>";
                        $serial++;
                  }
                  $table .= '</tbody></table>';
              ...
              $sql1 = "SELECT COUNT(c_id) FROM category";
